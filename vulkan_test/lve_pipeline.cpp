...
namespace lve {
    ...
    void LvePipeline::createGraphicsPipeline(const string& vertFilepath, const string& fragFilepath, PipelineConfigInfo configInfo) {
        ...
        auto attributeDescriptions = LveModel::Vertex::getBindingAttributes();
